...
import { registerController, loginController, forgotPasswordController } from '@/controllers/users.controllers'
import { registerValidator, loginValidator, forgotPasswordValidator } from '@/middlewares/users.middlewares'
